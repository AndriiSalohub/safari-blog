...
import "./IntroduceBlock.scss";

export const IntroduceBlock = () => {
    return (
        <>
            <div className="introduce-block">
                <div className="introduce">
                    ...
                    <div className="introduce-information">
                        ...
                        />
                        <h3 className="introduce-information-title">
                            WE LOVE SAFARI
                        </h3>
                        <p className="introduce-information-text">
                            Aliquam ac dui vel dui vulputate consectetur. Mauris
                            accumsan, massa non consectetur condimentum, diam
                            arcu tristique nibh, nec egestas diam elit at nulla.
                            Suspendisse potenti. In non lacinia risus, ac tempor
                            ipsum. Phasellus venenatis leo eu semper varius.
                        </p>
